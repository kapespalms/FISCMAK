...
export function CatalogMatchSection({
  ...
  return (
    <section className="rounded-2xl border border-cx-forest-dark/15 bg-cx-forest-dark/[0.03] p-5">
      <h2 className="text-base font-semibold text-cx-text">Catalog match</h2>
      ...
      <div className="mt-3 rounded-xl border border-cx-forest-dark/10 bg-white/90 p-4">
        <p className="text-sm font-medium text-cx-text">{primary.name}</p>
        ...
        <Link
          ...
          className="mt-3 inline-block text-sm font-medium text-cx-text underline-offset-2 hover:underline"
        >
