...
const variants: Record<Variant, string> = {
  ...
  secondary:
    "bg-white text-cx-text border border-cx-forest-dark/20 hover:bg-cx-forest-dark/5",
  destructive: "bg-fm-attention text-white hover:opacity-90",
  link: "bg-transparent text-cx-text hover:text-cx-text/80 hover:underline p-0 min-h-0",
};
