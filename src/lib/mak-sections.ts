...
export const FIVE_OPTIONS = [
  ...
  },
  {
    ...
    subtitle: "Insights from your coaching conversation",
    href: "/app/assessment",
    greeting: "Here's what I'm seeing in your pattern so far.",
...
export const MAK_SECTION_CONFIG: Record<AppSection, MakSectionConfig> = {
  ...
  assessment: {
    greeting: "Here's what I'm seeing in your career pattern so far. What resonates — or what feels off?",
    quickOptions: [
      "What's my career pattern?",
      "Show my blind spots",
      "What's draining me?",
      "Where are my recognition gaps?",
    ],
    placeholder: "Reflect on your patterns with Mak…",
    mode: "Analyst",
  },
  plan: {
    greeting: "Let's build your strategy.",
...
export const MAK_FLOW_GREETINGS: Record<MakFlowIntent, string> = {
  ...
  assess: "Here's what I'm learning about your career. What should we explore next?",
