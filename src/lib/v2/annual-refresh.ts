...
export const ANNUAL_REFRESH_MODULES: AnnualRefreshModule[] = [
  ...
  {
    id: "wellbeing_check",
    name: "Well-Being Annual Check",
    items: 6,
    minutes: 2,
    description: "WHO-5 + Single-Item Burnout annual reassessment",
    conversation_id: "S-1",
  },
  {
    id: "invisible_work_burden",
    name: "Invisible Work Burden",
    items: 3,
    minutes: 2,
    description: "Unrecognized work hours and task-load review",
    conversation_id: "S-2",
  },
  {
