...
export const KEYWORD_FISCMAK: Array<{
  ...
  { keywords: ["teach", "lecture", "curriculum", "learner", "education"], domainIndex: 4, trackIndex: 1, acgmeKey: "pbli", baseLevel: 3 },
  { keywords: ["mentor", "coach", "sponsor", "trainee", "resident"], domainIndex: 7, trackIndex: 1, acgmeKey: "ics", baseLevel: 3 },
