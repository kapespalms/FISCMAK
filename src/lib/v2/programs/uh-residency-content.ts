...
const ADMIN_PAGES: ResidencyPageContent[] = [
  {
    ...
    seeded: true,
    overviewText:
      "Faculty profiles, attending and resident contact tables, and links to MedHub psychiatry call, QGenda neurology/IM call, and the shared resident life calendar.",
    sections: {
      overview: [
        "Faculty profiles include photos, biographical information, research interests, and contact details — use to identify mentors and collaborators.",
        "Attending and resident contact tables list office phones, cells, pagers, and emails. Reach out to the chief resident or program coordinator if you need a number not listed.",
      ],
      personnel: [
        ...
        "Chief Resident — call switch questions, extra duty, and resident workflow",
        "Attending contact table — office phone, cell, pager, and notes (legacy resident site)",
        "Resident contact table — pager, personal email, and UH email",
      ],
      schedule: [
