/** Static brand PNGs in /public/brands (transparent). */
export const MAK_AVATAR_SRC = "/brands/mak-avatar.png";
export const DEFAULT_PROFILE_AVATAR_SRC = "/brands/default-profile.png";
export const HERO_CHESS_SRC = "/brands/hero-chess.png";
export const LOGO_CM_SRC = "/brands/logo-cm.png";

/** Marketing landing composites (uploaded brand art). */
export const LANDING_HERO_QUEEN_SRC = "/marketing/landing/hero-queen-transparent.png";
export const LANDING_LOGO_CM_SRC = "/marketing/landing/fiscmak-logo-cm.png";
