...
import { PdResidentDetailPanel } from "@/components/program/PdResidentDetailPanel";
...
export default async function ResidentDetailPage({ params }: PageProps) {
  ...
  return (
    <PageShell eyebrow="Program · Resident" title="Resident Detail" maxWidth="xl">
      <PdResidentDetailPanel programId={programId} userId={userId} />
    </PageShell>
  );
}
