    ...
    <div className="mx-auto max-w-3xl space-y-8">
      <div>
        <h1 className="flex items-center gap-2 text-3xl font-bold">
          <FileText className="text-fiscmak-green" size={28} />
          Documents
        </h1>
        <p className="mt-1 text-fiscmak-muted">
          Upload CV, personal statement, or dossier — parsed into career evidence
        </p>
      </div>
      ...
      <Card>
        <label
          htmlFor="file-upload"
          className="flex cursor-pointer flex-col items-center rounded-lg border-2 border-dashed border-fiscmak-border bg-fiscmak-subtle px-6 py-12 transition-colors hover:border-fiscmak-green hover:bg-fiscmak-green-light"
        >
          <Upload className="text-fiscmak-green" size={32} />
